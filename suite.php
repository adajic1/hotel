...
<body class="no_margin-no_padding" onload="loaded();" style="font-family: Georgia, serif;">
	...
	<table cellspacing="0" cellpadding="0" border="0" id="layout_table" width="95%">
		<tr><td align="center">
			...
			<a href="chambre.php" style="text-decoration: none; color: black;">CHAMBRE</a> <?php for($i=0; $i<8; $i++) print "&nbsp;"; ?> - <?php for($i=0; $i<8; $i++) print "&nbsp;"; ?> 
			<a href="#" style="text-decoration: none; color: blue;"><b>SUITE</b></a>
			<hr style="height: 15px; width: 99%; margin:0 auto; background: none; border:0 none;"/>
			
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
				<tr>		
					<td></td>							
					<td align="center" valign="middle" style="position: relative; border-width: 1px; border-style: solid; border-color: #000000;" width="50%">
						<a href="suite_junior.php" style="text-decoration: none; color: black;">
						<img src="images/suite_1.jpg" width="100%" height="300px" style="margin:0px; padding: 0px; float: left;">
    					...
    					<div style="position: absolute; top: 85%; left: 50%; transform: translate(-50%, -50%); white-space: nowrap;">							
							<a href="suite_junior.php" class="yellow_button">En savoir plus</a>
						</div>	
						</a>		
					</td>
					<td></td>						
