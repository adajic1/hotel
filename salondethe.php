...
<body class="no_margin-no_padding" onload="loaded();" style="font-family: Georgia, serif;">
	...
	<table cellspacing="0" cellpadding="0" border="0" id="layout_table" width="95%">
		<tr><td align="center">
			...
			<a href="#" style="text-decoration: none; color: blue;"><b>SALONDETHE</b></a> 
			...
			<table cellspacing="0" cellpadding="0" border="0" width="100%">
				...
				<tr>
					<td></td>
					<td style="border-width: 1px; border-style: solid; border-color: #5e68ee#5e68ee; padding: 10px; border-top: none;" colspan="3">
						<b>Salondethe</b><br>
						<p>
